import riskconnect1 from "@/assets/riskconnect1.png";
import riskconnect2 from "@/assets/riskconnect2.png";
import riskconnect3 from "@/assets/riskconnect3.png";
import riskconnect4 from "@/assets/riskconnect4.png";
import riskconnect5 from "@/assets/riskconnect5.png";
...
export default function RiskConnectedMindmap() {
  ...
  return (
    <div className="h-full overflow-y-hidden bg-white">
      <div
        ref={containerRef}
        className="scale-90 relative h-screen w-full max-w-6xl mx-auto"
        style={{
          display: "grid",
      ...
      >
        ...
        <div
          ...
          className="z-10 bg-gradient text-center text-[12px] md:text-sm
            lg:text-md font-heading font-semibold hover:[background-image:var(--connect-mindmap-bg-hover)]  [background-image:var(--connect-mindmap-bg)]  rounded-2xl h-full w-full flex justify-center items-center text-white px-2 py-4  md:p-2 hover:shadow-md hover:shadow-blue-500"
        >
          <h4>Our Risk Management Approach to Achieving Community Wellbeing</h4>
        </div>
        ...
        >
          <MindMapImage
            ...
            transition={transitionConfig.bottomLeft.transition}
            src={riskconnect1}
            alt="Modernizing Policies"
            title="Modernizing Policies"
        ...
        >
          <MindMapImage
            ...
            transition={transitionConfig.bottomRight.transition}
            src={riskconnect3}
            alt="Co-creating Community Solutions"
            title="Co-creating Community Solutions"
            className="w-full max-w-md text-center"
          ></MindMapImage>
        </div>
        ...
        >
          <MindMapImage 
            ...
            transition={transitionConfig.bottomCenter.transition}
            src={riskconnect5}
            title="Cooperative Frameworks"
            alt="Cooperative Frameworks"
        ...
        <div
          style={{
            ...
            gridRowStart: "2",
            gridRowEnd: "2",
            transform: "translate(0%,20%)", // 🔥 move upward
          }}
          className="flex justify-center items-center p-4"
        >
          <motion.svg
            style={{
              transformOrigin: "bottom center", // 🔥 important (reverse direction)
            }}
            variants={svg_Vars}
            initial="initial"
            animate={isInView ? "animate" : "initial"}
            transition={transitionConfig.topCenter?.transition}
            width="22"
            height="147"
            viewBox="0 0 22 147"
            fill="none"
          ...
          >
            <path
              d="M10.6668 0C16.5578 0 21.3334 4.77563 21.3334 10.6667C21.3334 16.5577 16.5578 21.3333 10.6668 21.3333C4.77572 21.3333 8.70419e-05 16.5577 8.67844e-05 10.6667C8.65269e-05 4.77563 4.77572 0 10.6668 0ZM10.6667 58.475L12.6667 58.475V58.475L10.6667 58.475ZM12.6667 145C12.6667 146.105 11.7713 147 10.6667 147C9.56217 147 8.66674 146.105 8.66674 145L10.6667 145H12.6667ZM10.6668 10.6667L12.6667 10.6667L12.6667 58.475L10.6667 58.475L8.66675 58.475L8.66674 10.6667L10.6668 10.6667ZM10.6667 58.475L12.6667 58.475L12.6667 145L10.6667 145L8.66674 145L8.66674 58.475L10.6667 58.475Z"
        ...
        <div
          style={{
            ...
            justifySelf: "center",
            gridColumnStart: "3",
            gridRowStart: "1", // ✅ stays top
            transform: "translate(0%, 10%)", // 🔥 adjust spacing
          }}
          className="flex justify-center items-center p-4"
        >
          <MindMapImage
            ...
            transition={transitionConfig.topCenter.transition}
            src={riskconnect2} // ✅ use different image (optional)
...
function MindMapImage({
  ...
  return (
    <motion.div
      ...
      initial={"initial"}
      animate={isInView ? "animate" : "initial"}
      transition={{ ...transition, delay: transition.delay + 0.5 }}
      className="w-full max-w-md text-center"
    >
      ...
      <h2 className="mt-4 text-[12px] sm:text-xl md:text-xl font-semibold text-[#24519E]">
        {title}
      </h2>
    </motion.div>
  );

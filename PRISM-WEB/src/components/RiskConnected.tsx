    ...
    <div className="h-full overflow-y-hidden bg-white">
      ...
      >
        ...
        <div
          ...
          onMouseEnter={() => {console.log('clcik')}}
          className="z-10 bg-gradient text-center text-[12px] md:text-lg
            lg:text-xl font-heading font-semibold hover:[background-image:var(--connect-mindmap-bg-hover)]  [background-image:var(--connect-mindmap-bg)]  rounded-2xl h-full w-full flex justify-center items-center text-white px-8 py-4  md:p-8 hover:shadow-md hover:shadow-blue-500"
        >
